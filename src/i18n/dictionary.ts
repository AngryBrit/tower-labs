...
export const STRINGS_EN = {
  ...
  ws_assist_unlocks_hint:
    'Per chassis slot: unique-effect tier and separate main (multiplier) / sub stone efficiency (max 70% each from stones). Costs match in-game stone upgrades.',
  ...
  ws_bot_special_unlock_cost_title: 'Cells to unlock this ability',
