...
export const STRINGS_EN = {
  ...
  themes_reset_confirm_body:
    'Restores default active selections for tower, background, music, menus, banners, and guardian, and clears all owned flags (FALSE). Saved in this browser only.',
  ...
  themes_owned_true: 'TRUE',
  themes_owned_false: 'FALSE',
...
export const STRINGS_ES = {
  ...
  themes_reset_confirm_body:
    'Restaura las selecciones activas predeterminadas y borra todas las posesiones (FALSE). Solo en este navegador.',
