...
export const STRINGS_ES = {
  ...
  ws_assist_unlocks_hint:
    'Por ranura de chasis: rareza del efecto único y eficiencia de piedras principal (multiplicador) y de subestadísticas por separado (máx. 70 % cada una con piedras). Costes como en el juego.',
  ...
  ws_bot_special_unlock_cost_title: 'Células para desbloquear',
