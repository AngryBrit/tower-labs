...
/** Card art in `public/` (wiki names as `Pascal_Snake.webp`). */
const CARD_IMAGE: Record<WorkshopGameCardId, string> = {
  damage: '/Damage.webp',
  attackSpeed: '/Attack_Speed.webp',
  health: '/Health.webp',
  healthRegen: '/Health_Regen.webp',
  range: '/Range.webp',
  cash: '/Cash.webp',
  coins: '/Coins.webp',
  slowAura: '/Slow_Aura.webp',
  criticalChance: '/Critical_Chance.webp',
  enemyBalance: '/Enemy_Balance.webp',
  extraDefense: '/Extra_Defense.webp',
  fortress: '/Fortress.webp',
  freeUpgrades: '/Free_Upgrades.webp',
  extraOrb: '/Extra_Orb.webp',
  plasmaCannon: '/Plasma_Cannon.webp',
  criticalCoin: '/Critical_Coin.webp',
  waveSkip: '/Wave_Skip.webp',
  introSprint: '/Intro_Sprint.webp',
  landMineStun: '/Land_Mine_Stun.webp',
  recoveryPackageChance: '/Recovery_Package_Chance.webp',
  deathRay: '/Death_Ray.webp',
  energyNet: '/Energy_Net.webp',
  superTower: '/Super_Tower.webp',
  secondWind: '/Second_Wind.webp',
  demonMode: '/Demon_Mode.webp',
  energyShield: '/Energy_Shield.webp',
  waveAccelerator: '/Wave_Accelerator.webp',
  berserker: '/Berserker.webp',
  ultimateCrit: '/Ultimate_Crit.webp',
  nuke: '/Nuke.webp',
  areaOfEffect: '/Area_Effect.webp',
}
