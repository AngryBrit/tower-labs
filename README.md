...
![Version](https://img.shields.io/badge/version-2.7.3-2ea44f)
...
| `ws,<field>,…` | Workshop persisted fields (upgrade/enhance levels, ultimate Plus levels, assist chassis unlocks/efficiency, active module sim, relic ownership, etc.). |
